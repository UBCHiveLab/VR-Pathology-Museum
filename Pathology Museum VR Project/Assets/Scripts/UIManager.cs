...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        systemToSprite = new Dictionary<BodySystem, Sprite>()
        {
            ...
            { BodySystem.SKELETAL, skeletonSprite }
        };
        ...
        organToSprite = new Dictionary<Organ, Sprite>()
        {
            ...
            { Organ.SKULL, skullSprite }, // needs sprite
            { Organ.KIDNEY, skullSprite }, // needs sprite
            { Organ.LIVER, skullSprite }, // needs sprite
            { Organ.RIGHT_LUNG, skullSprite } // needs sprite
        };
    ...
    /// <summary>
    /// Used for skipping the instructions tutorial
    /// </summary>
    public void StopTutorialInsturctions()
    {
        StopCoroutine("ShowAllInstructions");
        StartCoroutine(ScaleCanvas(instructionsPopup.transform, Vector3.zero, 1f));
        bothControllers.SetActive(false);
    }
